...
const projects = [
  {
    ...
    description: "A comprehensive design system built for scalability. Tokens, components, and documentation all in one.",
  ...
  },
  {
    ...
    description: "A mindfulness and focus app with smooth animations and immersive audio experiences.",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {projects.map((project, i) => (
          <FadeUp key={project.title} delay={i * 0.12}>
            <div className="group relative rounded-xl bg-card border border-border card-hover overflow-hidden h-full flex flex-col">
